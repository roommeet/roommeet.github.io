...
//                 for (secondRawInfo of rawLocations){
//                   // manipulate here match the coord to the thing
//                   // console.log(secondRawInfo.value)
//                 }
...
//     callGeocode()
  ...
  function addMarker(informations){
    ...
    var coords = {lat: Number(localityArray[5]), lng: Number(localityArray[6])}
    // console.log(coords)
    // console.log(informations)
    var content = "Name: " + localityArray[0].trim() + "</br>" + "Type: " + localityArray[3].trim() + "</br>" + "Address: " + localityArray[2].trim() + "</br>" + "Price: $" + localityArray[1].trim() + "</br>" + "Size: " + localityArray[4].trim() + "sqft";
    // console.log(content);
    var icon = {
