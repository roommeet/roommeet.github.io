...
<?php
    ...
    if(isset($_POST['booking_start'])&&isset($_POST['pass_price'])&&isset($_POST['bookingOption'])&&isset($_POST['fname'])&&isset($_POST['lname'])&&isset($_POST['email'])&&isset($_POST['mobile'])){
      $_SESSION["booking_start"] =$_POST['booking_start'];
      $price = $_POST['pass_price'];
      $_SESSION["bookingOption"] = $_POST['bookingOption'];
      $fname = $_POST['fname'];
      $lname = $_POST['lname'];
      $email = $_POST['email'];
      $mobile = $_POST['mobile'];
    ...
    // echo $_SESSION["booking_start"];
    // echo $_SESSION["bookingOption"];
           ...
           onApprove: function(data, actions) {
             return actions.order.capture().then(function(orderData) {
               // Successful capture! For dev/demo purposes:
                   ...
                   window.location.href = "server/helper/createBooking.php";
               element.innerHTML = '';
